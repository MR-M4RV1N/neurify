...
class AboutController extends AbstractController
{
    ...
    /**
     * @Route("/cpanel/project/description", name="app_project_description")
     */
    public function description(): Response
    {
        $lang = $this->getUser()->getLang();

        return $this->render('cpanel/about/description.html.twig', [
            'descriptions' => \App\Data\ProjectDescriptionData::getAll($lang),
        ]);
    }
}
